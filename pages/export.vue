    ...
    >
      ...
      <div>
        ...
        <ul class="mb-8">
          ...
          <li class="line-bullet font-bold">Sudamérica</li>
          <li class="line-bullet font-bold">Europa</li>
          <li class="line-bullet font-bold">Asia</li>
...
.line-bullet::before {
  ...
  @apply w-4 h-1 absolute -left-6 bg-california;
}
</style>
